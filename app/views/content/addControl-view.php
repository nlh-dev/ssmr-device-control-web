    ...
    <div class="p-4 mt-14">
        ...
        <form action="" class="AjaxForm" method="POST" autocomplete="off">
            ...
            <div class="flex justify-end items-center sm:col-span-1 lg:col-span-2 xl:col-span-3">
                ...
                <button type="" id="cancelButton" class="sm:mb-2 ml-3 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
                    Cancelar
                </button>
            </div>
        </form>
