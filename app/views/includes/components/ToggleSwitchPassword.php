<label class="inline-flex items-center cursor-pointer">
    <input type="checkbox" onchange="ToggleSwitchPassword()" class="sr-only peer">
    ...
    <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Mostrar Contraseña</span>
</label>